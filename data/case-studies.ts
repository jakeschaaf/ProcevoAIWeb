...
export const invoiceSplitterCaseStudy: CaseStudyCardProps = {
  ...
  problem:
    'Manual invoice processing where multi-invoice PDFs needed to be split and routed individually. NetSuite AP module only accepts one invoice per file, requiring manual splitting and emailing—costing 15+ hours per week.',
  solution:
